...
<svelte:head>
	<title>{!page.url.pathname[1] ? 'Home' : page.url.pathname[1].toUpperCase() + page.url.pathname.slice(2)} | Mansion Men</title>
</svelte:head>
...
<style>
	...
	nav {
		background-color: hsl(349.88deg 53.55% 30.39%);
		position: relative;
		z-index: 2;
		border-bottom: 1px solid hsl(349.88deg 53.55% 25.39%);
		box-shadow: 0 0 8px 0 hsl(349.88deg 53.55% 20.39%);
	}
